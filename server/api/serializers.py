...
class UserSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = [
			...
			'phone_number', 'address', 'status', 'document_id', 'registration_date',
...
class CanineSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Canine
		fields = [
			'id', 'client', 'client_name', 'name', 'breed', 'age', 'size',
			'photo', 'creation_date', 'status'
		]
...
class EnrollmentSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = Enrollment
		fields = [
			'id', 'canine', 'canine_name', 'plan', 'plan_name',
			'transport_service', 'transport_service_name', 'enrollment_date',
			'expiration_date', 'total_price', 'status', 'creation_date'
		]
		read_only_fields = ['creation_date']
...
class AttendanceSerializer(serializers.ModelSerializer):
	...
	client_name = serializers.CharField(source='enrollment.canine.client.user.get_full_name', read_only=True)
	
	class Meta:
		model = Attendance
		fields = [
			'id', 'enrollment', 'canine_name', 'client_name', 'date',
			'arrival_time', 'status', 'departure_time', 'withdrawal_reason', 'observations'
		]
