...
class User(AbstractUser):
	...
	document_id = models.CharField(max_length=50, unique=True, blank=True)
...
class InternalUser(models.Model):
    ...
    photo = models.ImageField(
        upload_to='internal_profile_photos/',
        blank=True,
        null=True
    )
...
class Enrollment(models.Model):
	...
	transport_service = models.ForeignKey(TransportService, on_delete=models.PROTECT, related_name='enrollments')
